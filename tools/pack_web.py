...
用法:
    python tools/pack_web.py vue_web/vue-ui/dist

输出:
    build/web_update.tar
"""
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print("Usage: python tools/pack_web.py <dist_dir> [output_path]")
        print("Example: python tools/pack_web.py vue_web/vue-ui/dist build/web_update.tar")
        sys.exit(1)
