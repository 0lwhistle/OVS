/**
 * @file ota.h
 * @brief OTA 升级模块公共 API
 * 
 * 提供空中固件升级功能，支持分块传输、SHA256 校验、自动回退。
 */
#ifndef OTA_H
#define OTA_H
...
#define OTA_CHUNK_SIZE    (16 * 1024)  /**< OTA 块大小 (16KB) */
#define OTA_QUEUE_DEPTH   128          /**< OTA 队列深度 */
#define OTA_MAGIC         0x4F56414F   /**< OTA 魔术数 ("OVAO") */
