...
## 2026-09-04 - 添加AHT30温湿度传感器电路

### 完成内容
- [x] 在PCB被动器件指南中添加AHT30电路
- [x] 更新采购清单（电容数量+2）

### 电路设计
- VCC去耦：C19(100nF) + C20(10µF)
- I2C上拉：复用R5、R6（已在I2C总线章节）
- 设备地址：AHT30=0x38，触控=0x15
...
- 其他模块：W25Q128、麦克风、功放、LoRa、AHT30、电源模块
...
- 其他模块：W25Q128、麦克风、功放、LoRa、AHT30（均≤25mm×20mm）
