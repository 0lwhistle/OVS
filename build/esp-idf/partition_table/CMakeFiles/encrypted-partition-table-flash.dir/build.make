...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash:
	cd /root/progarms/ovs/build/esp-idf/partition_table && /usr/bin/cmake -E echo "Error: The target encrypted-partition-table-flash requires"
	cd /root/progarms/ovs/build/esp-idf/partition_table && /usr/bin/cmake -E echo "CONFIG_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT to be enabled."
	cd /root/progarms/ovs/build/esp-idf/partition_table && /usr/bin/cmake -E env "FAIL_MESSAGE=Failed executing target (see errors on lines above)" /usr/bin/cmake -P /root/esp-idf/esp-idf-v6.0.1/tools/cmake/scripts/fail.cmake
...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash.dir/clean:
	cd /root/progarms/ovs/build/esp-idf/partition_table && $(CMAKE_COMMAND) -P CMakeFiles/encrypted-partition-table-flash.dir/cmake_clean.cmake
...
esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash.dir/depend:
	cd /root/progarms/ovs/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/progarms/ovs /root/esp-idf/esp-idf-v6.0.1/components/partition_table /root/progarms/ovs/build /root/progarms/ovs/build/esp-idf/partition_table /root/progarms/ovs/build/esp-idf/partition_table/CMakeFiles/encrypted-partition-table-flash.dir/DependInfo.cmake --color=$(COLOR)
